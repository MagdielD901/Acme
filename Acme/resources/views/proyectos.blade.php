                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../Panel/assets/img/small-logos/logo-invision.svg" class="avatar avatar-sm rounded-circle me-2" alt="invision">
                          </div>
                          <div class="my-auto">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../Panel/assets/img/small-logos/logo-jira.svg" class="avatar avatar-sm rounded-circle me-2" alt="jira">
                          </div>
                          <div class="my-auto">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../Panel/assets/img/small-logos/logo-slack.svg" class="avatar avatar-sm rounded-circle me-2" alt="slack">
                          </div>
                          <div class="my-auto">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../Panel/assets/img/small-logos/logo-webdev.svg" class="avatar avatar-sm rounded-circle me-2" alt="webdev">
                          </div>
                          <div class="my-auto">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src="../Panel/assets/img/small-logos/logo-xd.svg" class="avatar avatar-sm rounded-circle me-2" alt="xd">
                          </div>
                          <div class="my-auto">
